...
<link rel="stylesheet" href="css/isolation_ward_css.css">
  ...
  <!--      General Info      -->
    <section id="generalinfo">
     ...
     <img src="images/gif/dialcall_gif.gif" >
       ...
       <div class="col-md-4 text-center">
        ...
        <h3>Total Isolation Wards</h3>
          <h6><?php get_isolation_count (); ?></h6>
        <h5></h5>
      </div>

      <div class="col-md-4 text-center">
         <img src="images/gif/bed_gif.gif" >
       <h3>Isolate Patients</h3>
    ...
    <!--        Map     -->
        ...
        <section id="showMap" >
          ...
          <?php require_once "mapIsolation.php"; ?>
        </section>
...
function get_patients_details ()
{
  $con=mysqli_connect("localhost","root","asd32145","Covid_19_dbms");
	$quary="select *from patients where patient_status='Isolate';";
