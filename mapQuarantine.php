<?php
        ...
        $query =  $db->query("SELECT * FROM quarantine_ward");
  ...
  <div id="map-canvas"></div>
    ...
    var locations = [
        ...
        [
            'AMC Service',
          '<p><a href="<?php echo $locations[0]['name'];?>">Quarantine Ward</a></p>',
    ...
    function initialize() {
      ...
      map = new google.maps.Map(document.getElementById('map-canvas'), mapOptions);
        ...
        for(i=0; i<locations.length; i++) {
            ...
            var image_hospital = new google.maps.MarkerImage("https://img.icons8.com/color/48/000000/hospital-3.png", null, null, null, new google.maps.Size(40,52)); // Create a variable for our marker image.
